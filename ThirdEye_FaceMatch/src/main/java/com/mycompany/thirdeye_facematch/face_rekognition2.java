 ...
 * @author Akash Sahu
 */
public class face_rekognition2 extends javax.swing.JFrame {

    public face_rekognition2() {
        initComponents();
    ...
    private void open_sketchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_open_sketchActionPerformed
        JFileChooser fileChooser = new JFileChooser("C:\\major\\Project Code (forensic face sketch)\\ThirdEye_FaceMatch\\src\\main\\java\\com\\mycompany\\thirdeye_facematch\\sketches"); 
    ...
    private void find_matchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_find_matchActionPerformed
        ...
        String secretKey = "WU9nkHqZq+ADD your AWS secretkey";
        ...
        faceImageMatches.forEach((FaceMatch face) -> {
            try {
                ...
                System.out.println("faceid " + face.getFace().getExternalImageId());
                
                try {
                    URL url = new URL("file:////C://major//copy//Project-Code-(forensic-face-sketch)//Project-Code-(forensic-face-sketch)//ThirdEye_FaceMatch//src//main//java//com//mycompany//thirdeye_facematch//faces//"+face.getFace().getExternalImageId());
                    match.setIcon(new ImageIcon(url));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            } catch (JsonProcessingException ex) {
                Logger.getLogger(face_rekognition2.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(face_rekognition2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new face_rekognition2().setVisible(true);
        });
    }
